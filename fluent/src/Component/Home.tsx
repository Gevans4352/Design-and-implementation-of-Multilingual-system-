...
const Home = () => {
    return (
        <div className="flex flex-col">
            <div className="flex flex-col md:flex-row px-4 md:px-10 items-center justify-between min-h-fit md:min-h-[calc(100vh-80px)] gap-6 md:gap-10 pt-2 pb-8 md:py-0 md:mt-0">

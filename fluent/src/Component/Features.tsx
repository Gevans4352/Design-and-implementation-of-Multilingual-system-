        ...
        <section className="py-16 md:py-20 px-4 md:px-10 bg-white">
            <div className="max-w-7xl mx-auto">
                <div className="text-center mb-12 md:mb-16">
                    <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4 px-2">Why Choose FluentRoot?</h2>
                    <p className="text-gray-500 text-base md:text-lg">Advanced AI technology meets cultural preservation</p>
                </div>
